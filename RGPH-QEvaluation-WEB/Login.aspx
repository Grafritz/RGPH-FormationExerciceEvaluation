...
<head runat="server">
    ...
    <title>RGPH - QUESTIONNAIRE - EXERCICE FORMATION : LOGIN</title>
                ...
                <div id="cl-wrapper" class="login-container">
                    <div class="middle-login">
                        <div class="block-flat">
                            ...
                            <div class="header">
                                <h3 class="text-center">
                                    <%--<asp:Image runat="server" ID="image1" Width="240px" ImageUrl="~/images/logo_sygas.png" />--%>
                                    <asp:Label ID="Label_Slogan" runat="server" Style="font-weight: 700; font-size: 18px; display: block; color: rgb(255, 255, 255);">
                                        RGPH - QUESTIONNAIRE - EXERCICE FORMATION
                                    </asp:Label>
                                </h3>
                            </div>
                            <div>
                        ...
                        <div class="text-center out-links">
                            ...
                            <a href="#" style="display:block;margin-top:10px;">&copy; 2013 Brain Development</a>
                        </div>
                    </div>
                </div>
            </ContentTemplate>
