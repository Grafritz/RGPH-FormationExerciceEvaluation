    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Is_Acces_Page Then
            If Not IsPostBack Then
                ...
                Btn_ADD_Questions.Attributes.Add("onclick", "javascript:void(ShowAddUpdateForm('Frm_QuestionsADD.aspx?" & [Global].ACTION & "=" & [Global].HideMenuHeader & "', 950, 650)); return false;")
...
#Region "SECURITE"
    Public Sub SYSTEME_SECURITE()
        Try
            ...
            CType(Page.Master.FindControl("li_QuestionsListing2"), HtmlControl).Attributes.Add("class", "active")
