...
Partial Class Frm_FormulaireExercicesListing
...
#Region "ATTRIBUTS"
    ...
    Private Const Nom_page As String = "PAGE-LISTING-FORMULAIREEXERCICES"  ' POUR LA PAGE
...
#Region "SECURITE"
    Public Sub SYSTEME_SECURITE()
        Try
            ...
            'CType(Page.Master.FindControl("li_FormulaireExercices"), HtmlControl).Attributes.Add("class", "active ")
            'CType(Page.Master.FindControl("i_FormulaireExercices"), HtmlControl).Attributes.Add("class", "fa fa-folder-open fa-lg ")
            ...
            CType(Page.Master.FindControl("li_FormulaireCollecteListing2"), HtmlControl).Attributes.Add("class", "active")
