<%@ Page Title=" Question Formulaire Exercice" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_QuestionFormulaireExerciceListing.aspx.vb" Inherits="Frm_QuestionFormulaireExerciceListing" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function MenuItemClicked(sender, eventArgs) {
                ...
                var rdGrid = $find("<%=rdgQuestionFormulaireExercice.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    switch (clickedItemValue) {
        case "Editer":
            ShowAddUpdateForm('Frm_QuestionFormulaireExerciceADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
        case "Delete":
            ShowAddUpdateForm('Frm_QuestionFormulaireExerciceADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
        default:
            break;
...
function RowContextMenu(sender, eventArgs) {
 ...
 function RowDblClick(sender, eventArgs) {
     ...
     var rdGrid = $find("<%=rdgQuestionFormulaireExercice.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    ShowAddUpdateForm('Frm_QuestionFormulaireExerciceADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550);
}
...
function GetRadWindow() {
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgQuestionFormulaireExercice">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgQuestionFormulaireExercice" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <div class="mail-inbox">
            <section class="page-head" id="PageHeader" runat="server">
                <h3>
                    ...
                    <asp:Label ID="Label_Titre" runat="server" Text=" Question Formulaire Exercice" />
    ...
    <li class="active"> Question Formulaire Exercice</li>
</ol> -->
            </section>
            <section class="content">
                ...
                <asp:Panel runat="server" ID="Panel_First" Style="margin: 5px;">
                    <asp:LinkButton ID="Btn_ADD_QuestionFormulaireExercice" runat="server" CssClass="btn btn-primary" CausesValidation="false">
    <i class="fa fa-plus-circle" ></i>  Ajouter  Question Formulaire Exercice
                    </asp:LinkButton>
        ...
        <i class="fa fa-ban on fa-filter" ></i> Clear Filters
                    ...
                    <telerik:RadGrid ID="rdgQuestionFormulaireExercice" AllowPaging="True" AllowSorting="True" PageSize="20"
                        ...
                        <MasterTableView CommandItemDisplay="Top" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="CodeFormulaireExerciceSTR" UniqueName="CodeFormulaireExercice" HeaderText=" Code Formulaire Exercice"
                                    FilterControlAltText="Recherche par  Code Formulaire Exercice" FilterControlWidth="95%" ShowFilterIcon="false"
                                ...
                                <telerik:GridBoundColumn DataField="OrdreQuestion" UniqueName="OrdreQuestion" HeaderText=" Ordre Question"
                                    FilterControlAltText="Filter OrdreQuestion column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="EstDebutQuestion" UniqueName="EstDebutQuestion" HeaderText=" Est Debut Question"
                                    FilterControlAltText="Filter EstDebutQuestion column" FilterControlWidth="95%" ShowFilterIcon="false"
