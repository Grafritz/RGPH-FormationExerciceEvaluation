...
#Region "VARIABLE MESSAGED"
    ...
    Public Const DATA_REPONSES_SESSION_2 = "DATA_REPONSES_SESSION_2"
    Public Const DATA_JUSTIFICATION_REPONSES_SESSION = "DATA_JUSTIFICATION_REPONSES_SESSION"

    Public Const GLOBAL_SESSION_DS_FORMULAIRE_EXERCICE = "GLOBAL_SESSION_DS_FORMULAIRE_EXERCICE"
    Public Const RECORD_NEXT As String = "RECORD_NEXT"
    Public Const RECORD_PRECEDENT As String = "RECORD_FORWARD"
