<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowReport_Evaluation.aspx.vb" Inherits="Pages_Fen_Report_ShowReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            SizeToReportContent="true" ShowFindControls="true" ShowPrintButton="true">
                <LocalReport ReportPath="_reports\Fen_Report\Report1.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="DataSet1" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringDataBase %>" SelectCommand="_REPORT_SP_FormulaireExercices_ByCodeExercise" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="CodeExercise" QueryStringField="ID" Type="Int64" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
