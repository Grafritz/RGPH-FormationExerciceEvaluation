<%@ Page Title=" Formulaire Exercices" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_FormulaireExercicesListing.aspx.vb" Inherits="Frm_FormulaireExercicesListing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgFormulaireExercices">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgFormulaireExercices" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <div class="mail-inbox">
            <section class="page-head" id="PageHeader" runat="server">
                <h3>
                    ...
                    <asp:Label ID="Label_Titre" runat="server" Text=" Formulaire Exercices" />
    ...
    <li class="active"> Formulaire Exercices</li>
</ol> -->
            </section>
            <section class="content">
                ...
                <asp:Panel runat="server" ID="Panel_First" Style="margin: 5px;">
                    <asp:LinkButton ID="Btn_ADD_FormulaireExercices" runat="server" CssClass="btn btn-primary" CausesValidation="false">
                        <i class="fa fa-plus-circle" ></i>  Ajouter  Formulaire Exercices
                    </asp:LinkButton>
                    ...
                    <telerik:RadGrid ID="rdgFormulaireExercices" AllowPaging="True" AllowSorting="True" PageSize="20"
                        ...
                        <MasterTableView CommandItemDisplay="Top" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="LibelleExercice" UniqueName="LibelleExercice" HeaderText=" Libelle Exercice"
                                    FilterControlAltText="Filter LibelleExercice column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Descriptions" UniqueName="Descriptions" HeaderText=" Descriptions"
                                    FilterControlAltText="Filter Descriptions column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="RappelExercice" UniqueName="RappelExercice" HeaderText=" Rappel Exercice"
