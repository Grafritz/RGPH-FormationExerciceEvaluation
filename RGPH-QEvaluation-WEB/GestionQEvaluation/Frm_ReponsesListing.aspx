<%@ Page Title=" Reponses" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_ReponsesListing.aspx.vb" Inherits="Frm_ReponsesListing" %>
...
function GetRadWindow() {
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgReponses">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgReponses" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <li class="active"> Reponses</li>
            ...
            <section class="content">
                ...
                <asp:Panel runat="server" ID="Panel_First" Style="margin: 5px;">
                    <asp:LinkButton ID="Btn_ADD_Reponses" runat="server" CssClass="btn btn-primary" CausesValidation="false">
    <i class="fa fa-plus-circle" ></i>  Ajouter  Reponses
                    </asp:LinkButton>
        ...
        <i class="fa fa-ban on fa-filter" ></i> Clear Filters
                    ...
                    <telerik:RadGrid ID="rdgReponses" AllowPaging="True" AllowSorting="True" PageSize="20"
                        ...
                        <MasterTableView CommandItemDisplay="Top" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="LibelleQuestion" UniqueName="LibelleQuestion" HeaderText=" Question"
