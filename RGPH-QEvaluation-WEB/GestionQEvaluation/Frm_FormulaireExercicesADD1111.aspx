<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" CodeFile="Frm_FormulaireExercicesADD1111.aspx.vb" Inherits="GestionQEvaluation_Frm_FormulaireExercicesADD" %>
...
<div class="col-sm-6">
   ...
   <div class="form-group">
<label class="col-sm-3 control-label">Statut
...
<div class="col-sm-6">
   ...
   <div class="form-group">
<label class="col-sm-3 control-label">Duree En Seconde
...
<div class="col-sm-6">
   <asp:TextBox ID="txt_DureeEnSeconde" CssClass="form-control" Width="100%" runat="server" placeholder="Duree En Seconde..."></asp:TextBox>
</div>
