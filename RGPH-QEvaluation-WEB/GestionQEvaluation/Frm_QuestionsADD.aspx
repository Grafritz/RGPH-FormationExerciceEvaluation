...
function GetRadWindow() {
   ...
   <asp:RequiredFieldValidator ID="RFV_qPrecedent" runat="server" ControlToValidate="txt_qPrecedent"
       ErrorMessage="q Precedent Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*"
       ValidationGroup="GPSave" CssClass="text-danger" />
                            </label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txt_qPrecedent" CssClass="form-control" Width="100%" runat="server" placeholder="q Precedent..."></asp:TextBox>
                            </div>
                        ...
                        <%--<div class="form-group">
                            <label class="col-sm-3 control-label">
                                q Suivant
   <asp:RequiredFieldValidator ID="RFV_qSuivant" runat="server" ControlToValidate="txt_qSuivant"
       ErrorMessage="q Suivant Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*"
       ValidationGroup="GPSave" CssClass="text-danger" />
                            </label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txt_qSuivant" CssClass="form-control" Width="100%" runat="server" placeholder="q Suivant..."></asp:TextBox>
                            </div>
