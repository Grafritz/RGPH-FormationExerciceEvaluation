...
Private _CodeFormulaireExercice As Cls_CodeFormulaireExercice
...
Public Property CodeFormulaireExerciceOBJ As Cls_CodeFormulaireExercice
Get
If Not (_CodeFormulaireExercice Is Nothing) ThenIf (_CodeFormulaireExercice.ID = 0) Or (_CodeFormulaireExercice.ID <>  _CodeFormulaireExercice) Then_CodeFormulaireExercice= New Cls_CodeFormulaireExercice(_CodeFormulaireExercice)End IfElse_CodeFormulaireExercice= New Cls_CodeFormulaireExercice(_CodeFormulaireExercice)End IfReturn _CodeFormulaireExerciceEnd GetSet(ByVal value As Cls_CodeFormulaireExercice)If Value Is Nothing Then_isdirty = True_CodeFormulaireExercice = 0ElseIf _CodeFormulaireExercice.ID <> Value.ID Then_isdirty = True_CodeFormulaireExercice = Value.IDEnd IfEnd IfEnd SetEnd Property

Public ReadOnly Property CodeFormulaireExerciceSTR As String
Get
Return CodeFormulaireExerciceOBJ.CodeFormulaireExercice
End Get
End Property
...
Get
If Not (_CodeQuestion Is Nothing) ThenIf (_CodeQuestion.ID = 0) Or (_CodeQuestion.ID <>  _CodeQuestion) Then_CodeQuestion= New Cls_CodeQuestion(_CodeQuestion)End IfElse_CodeQuestion= New Cls_CodeQuestion(_CodeQuestion)End IfReturn _CodeQuestionEnd GetSet(ByVal value As Cls_CodeQuestion)If Value Is Nothing Then_isdirty = True_CodeQuestion = 0ElseIf _CodeQuestion.ID <> Value.ID Then_isdirty = True_CodeQuestion = Value.IDEnd IfEnd IfEnd SetEnd Property
